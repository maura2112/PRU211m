...
public class UI_HealthBar2 : MonoBehaviour
{
    public GameObject heartPrefs;
    //public float health, maxHealth;
    public Player2Health playerHealth;
    List<UI_Health> hearts = new List<UI_Health>();

    private void OnEnable()
    {
        Player2Health.OnPlayerDamaged += DrawHearts;
        Player2Health.OnPlayerHealth += DrawHearts;
    }
